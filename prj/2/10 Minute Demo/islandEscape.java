...
public static void printStory() {
  ...
  if (userinput25.equals( "use fire")){
    monacle.usedItem = true;
    rocks.usedItem = true;
    leaves.usedItem = true;
    flint.usedItem = true;
    puz5.puzSolved = true;
    fire.hasItem = true;
    System.out.println("");
